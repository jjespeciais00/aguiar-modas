<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=auto&color=auto&height=200&section=header&text=Aguiar%20Modas&fontSize=50&fontColor=ffffff&desc=E-Commerce%20Premium%20SPA&descAlign=50&descAlignY=55" alt="Aguiar Modas Banner">
</div>

<h3 align="center">Plataforma de E-Commerce moderna, otimizada para performance e conversão ágil via WhatsApp.</h3>
...
- **Carrinho & Micro-interações:** Gerenciamento robusto de carrinho de compras utilizando toasts notifications e modais *Quick-View* de produtos para uma sensação premium.
...
```bash
# Clone o repositório
$ git clone https://github.com/jjespeciais00/aguiar-modas.git

# Acesse a pasta do projeto
$ cd aguiar-modas

# Suba um servidor local para servir os arquivos estáticos (SPA)
# (Usando NPX serve)
$ npx serve .
...
Abra seu navegador na porta indicada para interagir com a aplicação completa.
